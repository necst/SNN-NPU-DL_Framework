...
void snnNeuronLineSimdInputHidden(int32_t *in, int32_t *out, float *inMem, float *outMem, float *inWeights, float threshold, float decay_factor, float reset, int32_t hard_reset, int32_t width){
  snn_neuron_aie_simd_<int32_t, 16>(in, out, inMem, outMem, inWeights, threshold, decay_factor, reset, hard_reset, width);
}

// Corrected signature for snnNeuronLineSimdHiddenOutput
void snnNeuronLineSimdHiddenOutput(int32_t *in, int32_t *out, float *inMem, float *outMem, float *inWeights, float threshold, float decay_factor, float reset, int32_t hard_reset, int32_t width){
  snn_neuron_aie_simd_<int32_t, 16>(in, out, inMem, outMem, inWeights, threshold, decay_factor, reset, hard_reset, width);
}
