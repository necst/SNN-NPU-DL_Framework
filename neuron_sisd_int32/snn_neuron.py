...
def snn_neuron(dev, in1_size, out_size, threshold, decay_factor, reset, trace_size):
    ...
    lif_neuron_sisd = Kernel("snnNeuronLineInteger","scale.o", [aie_tile_ty, aie_tile_ty, np.int32, np.int32, np.int32, np.int32],)
    ...
    def core_body(of_in_spikes_0, of_out_spikes_0, lif_neuron):
        for _ in range_(number_sub_vectors):
            ...
            lif_neuron(elem_in_spikes, elem_out, threshold, decay_factor, reset, tile_size)
