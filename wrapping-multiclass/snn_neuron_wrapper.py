...
class snn_neuron_npu_multicore(base_neuron):
    # Overload
    def __init__(self, in1_size=4096, out_size=4096, threshold=5, decay_factor=0.9, reset=-1, hard_reset=1, trace_size=8192, use_placed=False, aie_design_name = "multicore", num_cores = 2):
...
class snn_neuron_npu_singlecore(base_neuron):
    # Overload
    def __init__(self, in1_size=4096, out_size=4096, threshold=5, decay_factor=0.9, reset=-1, hard_reset=1, trace_size=8192, use_placed=False, aie_design_name = "singlecore"):
        super().__init__(in1_size=in1_size, out_size=out_size, threshold=threshold, decay_factor=decay_factor, reset=reset, hard_reset=hard_reset, trace_size=trace_size, use_placed=use_placed)
