...
def snn_neuron(dev, in1_size, out_size, threshold, decay_factor, reset, hard_reset, trace_size, vectorized):
    ...
    of_in_membrane = ObjectFifo(membrane_ty, name="in_out_membrane", depth=2)
...
p.add_argument("-vt", "--vectorized", required=False, dest="vectorized", default=0, help="Choose between the scalar unit and global one")
